...

{
  product(handle: "${handle}") {
    ...
    metafields(identifiers: [ 
      {namespace: "ppm", key: "details"}, 
      {namespace: "ppm", key: "packaging"}, 
      {namespace: "ppm", key: "manufactured"}, 
      {namespace: "ppm", key: "material"}, 
      {namespace: "ppm", key: "made"}, 
      {namespace: "ppm", key: "dimension"}, 
     ]) {   
      namespace
      key
      value
